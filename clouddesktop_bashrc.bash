...
echo "[running clouddesktop_bashrc.bash]"
...
echo -e "++++++++++++++++++++++++++++++++++++++++++++++++++
ROS Melodic is the current version"
export EDITOR=nano

#### WORKSPACE
echo "ROS WORKSPACE: MiniRover"
echo "ROS_IP is $ROS_IP and ROS_MASTER_URI is $ROS_MASTER_URI"
